...
// Cross Module References
	...
	FORTNITETOWERDEFENSE_API UFunction* Z_Construct_UFunction_ATD_Pawn_InceaseWave();
...
// End Cross Module References
	void ATD_Pawn::StaticRegisterNativesATD_Pawn()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "InceaseWave", &ATD_Pawn::execInceaseWave },
		};
	...
	struct Z_Construct_UFunction_ATD_Pawn_InceaseWave_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATD_Pawn_InceaseWave_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "TD_Pawn.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ATD_Pawn_InceaseWave_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATD_Pawn, nullptr, "InceaseWave", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATD_Pawn_InceaseWave_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATD_Pawn_InceaseWave_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATD_Pawn_InceaseWave()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ATD_Pawn_InceaseWave_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATD_Pawn_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ATD_Pawn_InceaseWave, "InceaseWave" }, // 2904780301
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ATD_Pawn, 3953275063);
